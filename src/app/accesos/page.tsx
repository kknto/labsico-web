      ...
      <section className="section section--muted">
        <div className="site-shell internal-access-shell">
          <SectionHeader
            ...
            description="Entrada protegida para herramientas internas de reportes, obra y gestion de la empresa."
          />
          <InternalAccessForm />
        </div>
      </section>
      ...
      <div className="site-shell">
        <div className="internal-access-header">
          <SectionHeader
            eyebrow="Accesos internos"
            title="Plataformas de LABSICO"
            description="Accesos centralizados para personal autorizado. Las URLs se configuran desde variables de entorno en Render."
          />
